...
import { ChartBar, Users, Clock, Shield, PieChart, CheckCircle, Book, List, Slack, Trello, Calendar, Mail, HelpCircle, FileText, Info } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group animate-in slide-in-from-bottom-4 duration-700 delay-100 bg-white/90 backdrop-blur-sm border-0 shadow-lg">
              ...
              <CardContent>
                ...
                <Button variant="outline" className="w-full bg-construction-navy text-white hover:bg-construction-darkBlue transition-all duration-300">
            ...
            <Card className="hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group animate-in slide-in-from-bottom-4 duration-700 delay-200 bg-white/90 backdrop-blur-sm border-0 shadow-lg">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl font-bold group-hover:text-construction-navy transition-colors duration-300">User Guide</CardTitle>
                <CardDescription className="text-base">
            ...
            <Card className="hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group animate-in slide-in-from-bottom-4 duration-700 delay-300 bg-white/90 backdrop-blur-sm border-0 shadow-lg">
              ...
              <CardContent>
                ...
                <Button variant="outline" className="w-full bg-construction-navy text-white hover:bg-construction-darkBlue transition-all duration-300" asChild>
                  <a href="/app/faq">View FAQs</a>
                </Button>
              </CardContent>
            </Card>
          </div>
