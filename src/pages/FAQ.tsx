    ...
    <div className="container max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="mb-8">
        <p className="text-muted-foreground">
          Find answers to commonly asked questions about ConstructPulse. If you can't find what you're looking for, 
          please contact our support team at support@constructpulse.com.
        </p>
      </div>
      
      <Accordion type="single" collapsible className="space-y-4">
        <AccordionItem value="item-1" className="border rounded-md px-4">
          <AccordionTrigger className="text-lg font-medium py-4">What is ConstructPulse?</AccordionTrigger>
          <AccordionContent className="pb-4">
            ConstructPulse is a comprehensive construction management platform designed to streamline project workflows, 
        ...
        <AccordionItem value="item-2" className="border rounded-md px-4">
          <AccordionTrigger className="text-lg font-medium py-4">How do I get started with ConstructPulse?</AccordionTrigger>
          <AccordionContent className="pb-4">
        ...
        <AccordionItem value="item-3" className="border rounded-md px-4">
          ...
          <AccordionContent className="pb-4">
            ConstructPulse offers four subscription tiers:
        ...
        <AccordionItem value="item-4" className="border rounded-md px-4">
          <AccordionTrigger className="text-lg font-medium py-4">Can I access ConstructPulse on mobile devices?</AccordionTrigger>
          <AccordionContent className="pb-4">
            Yes, ConstructPulse is fully responsive and can be accessed on any device with a web browser. 
        ...
        <AccordionItem value="item-5" className="border rounded-md px-4">
          <AccordionTrigger className="text-lg font-medium py-4">How secure is my data on ConstructPulse?</AccordionTrigger>
          <AccordionContent className="pb-4">
            We take data security very seriously. ConstructPulse uses industry-standard encryption for all data in transit 
        ...
        <AccordionItem value="item-6" className="border rounded-md px-4">
          <AccordionTrigger className="text-lg font-medium py-4">Can I customize reports in ConstructPulse?</AccordionTrigger>
          <AccordionContent className="pb-4">
            Absolutely! ConstructPulse offers a variety of report templates (daily site reports, safety reports, 
        ...
        <AccordionItem value="item-8" className="border rounded-md px-4">
          ...
          <AccordionContent className="pb-4">
            Yes, ConstructPulse supports collaboration with external partners. You can invite consultants, subcontractors, 
        ...
        <AccordionItem value="item-9" className="border rounded-md px-4">
          <AccordionTrigger className="text-lg font-medium py-4">What kind of support does ConstructPulse offer?</AccordionTrigger>
          <AccordionContent className="pb-4">
        ...
        <AccordionItem value="item-10" className="border rounded-md px-4">
          <AccordionTrigger className="text-lg font-medium py-4">Can I export my data from ConstructPulse?</AccordionTrigger>
          <AccordionContent className="pb-4">
            ...
            If you decide to discontinue using ConstructPulse, we provide tools to help you extract all your 
