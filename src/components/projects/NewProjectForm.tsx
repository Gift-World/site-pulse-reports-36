...
export function NewProjectForm({ onComplete }: NewProjectFormProps) {
  ...
  const onSubmit = (data: FormValues) => {
    ...
    toast({
      ...
      description: `Project "${data.name}" has been successfully created with budget ${selectedCurrency?.symbol}${Number(data.cost).toLocaleString()}. All project files have been uploaded to the documents section.`,
    });
